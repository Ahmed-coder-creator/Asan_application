...
class MainActivity19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val years =
            arrayListOf<Int>(1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007)
        val birthplace = arrayListOf<String>(
            "Azərbaycan",
            "Türkiyə",
            "Gürcüstan",
            "Rusiya Federasiyası",
        ...
        val arrayAdapter5 =
            ArrayAdapter<Int>(this, android.R.layout.simple_spinner_dropdown_item, years)
        spinner5.adapter = arrayAdapter5
        val spinner6 = binding.spinner6
        val arrayAdapter6 =
            ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, birthplace)
        ...
        binding.hamburger3.setOnClickListener {
        ...
        binding.lagvetshaxsi.setOnClickListener {
            val intent = Intent(this, MainActivity3::class.java)
            startActivity(intent)
        }
        binding.yaddasaxlashexsi.setOnClickListener {
            if (binding.ad.text.toString().isNullOrEmpty()){
                binding.ad.setError("Boş ola bilməz")
            }
            if (binding.soyad.text.toString().isNullOrEmpty()){
                binding.soyad.setError("Boş ola bilməz")
            }
            if (binding.atadi.text.toString().isNullOrEmpty()){
                binding.atadi.setError("Boş ola bilməz")
            }
            if (binding.ad.text.toString().isNullOrEmpty()==false && binding.soyad.text.toString().isNullOrEmpty()==false && binding.atadi.text.toString().isNullOrEmpty()==false){
                val intent=Intent(this,MainActivity3::class.java)
                startActivity(intent)
                finish()
            }
